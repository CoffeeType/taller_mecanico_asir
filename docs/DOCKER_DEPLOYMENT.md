...
- Inicializa la base de datos automáticamente (solo la primera vez, cuando el volumen `mysql_data` está vacío)
...
### Error al registrar: `Unknown column 'calle' in 'field list'`
